...
static SObject2DData Generate2DRectangle(const XMFLOAT2& RectangleSize)
{
	...
	Result.vVertices.emplace_back(SVertex2D(XMVectorSet(-HalfWidth, +HalfHeight, 0, 1), XMVectorSet(1, 1, 1, 1), XMVectorSet(0.0f, 0.0f, 0, 1)));
	Result.vVertices.emplace_back(SVertex2D(XMVectorSet(+HalfWidth, +HalfHeight, 0, 1), XMVectorSet(1, 1, 1, 1), XMVectorSet(1.0f, 0.0f, 0, 1)));
	Result.vVertices.emplace_back(SVertex2D(XMVectorSet(-HalfWidth, -HalfHeight, 0, 1), XMVectorSet(1, 1, 1, 1), XMVectorSet(0.0f, 1.0f, 0, 1)));
	Result.vVertices.emplace_back(SVertex2D(XMVectorSet(+HalfWidth, -HalfHeight, 0, 1), XMVectorSet(1, 1, 1, 1), XMVectorSet(1.0f, 1.0f, 0, 1)));
